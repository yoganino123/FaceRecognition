...
faceID = input ("Masukan Nomor FaceID yang akan direkam Daranya [Kemudian Tekan ENTER]: ")
print ("Tatap Wajah anda ke Camera / WebCam. Tunggu Pengambilan data Wajah Selesai...")
ambilData = 1
while True:
    retV, frame = cam.read()
